...
public class Stock extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "RR Item Id", "Item (Rice) Name", "Qty (Kg)", "Qty (Mt)", "Price", "Amount"
            }
        ) {
    ...
    private void tableLoad() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                v.add(String.valueOf(Double.parseDouble(rs.getString("qty")) / 1000));//mt
                v.add(rs.getString("rr_price"));
                v.add(String.valueOf(Double.parseDouble(rs.getString("qty")) * Double.parseDouble(rs.getString("rr_price"))));//amount
